	...
	case CARD:
		{	
			...
			for (int i = 0; i < num_cards; ++i) {
				...
				if(NewCard) NewCard->Load(loadFile, this);
			}
		}
		break;
...
Card* Grid::createSpecificCard(int x) 
{
	...
	switch (x) 
	{
	case 1:  return new CardOne();break;
	case 2:  return new CardTwo();break;
	case 3:  return new CardThree();break;
	case 4:  return new CardFour();break;
	case 5:  return new CardFive();break;
	case 6:  return new CardSix();break;
	case 7:  return new CardSeven();break;
		//case 8 ://		break;
	case 9:  return new CardNine();break;
	case 10: return new CardTen();break;
	case 11: return new CardEleven();break;
	case 12: return new CardTwelve();break;
	case 13: return new CardThirteen();break;
	case 14: return new CardFourteen();   break;
